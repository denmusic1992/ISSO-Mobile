...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
   ...
   // public static IssoViewActivity issoActivity;                       //класс для вызова списка рейтингов/работ/...
    ...
    /** конструктор */
    public MapsActivity(HttpsIsso[] listOfIssos, LocationManager locationManager, Drawable[] draw) {
        super();
    ...
    public void setTheRest (final HttpsIsso isso, TextView tv, ImageView rate, ImageView geo, int rating, Drawable[] draw, Drawable marker) {
        try {
           /* String str = String.format("%.3f", isso.WIsso);
            ...
            switch (rating) {
                case 0:
                    rate.setImageResource(R.drawable.emergency);
                    break;
                case 1:
                    rate.setImageResource(R.drawable.pre_emergency);
                    break;
                case 2:
                    rate.setImageResource(R.drawable.non_satisfied);
                    break;
                case 3:
                    rate.setImageResource(R.drawable.satisfied);
                    break;
                case 4:
                    rate.setImageResource(R.drawable.well_done);
                    break;
                case 5:
                    rate.setImageResource(R.drawable.well_done);
                    break;
                case 6:
                    rate.setImageResource(R.drawable.not_actual);
                    break;
                case 201:
                    rate.setImageResource(R.drawable.emergency_not_actual);
                    break;
                case 202:
                    rate.setImageResource(R.drawable.pre_emergency_not_actual);
                    break;
                case 203:
                    rate.setImageResource(R.drawable.non_satisfied_not_actual);
                    break;
                case 204:
                    rate.setImageResource(R.drawable.satisfied_not_actual);
                    break;
                case 205:
                    rate.setImageResource(R.drawable.well_done_not_actual);
                    break;
            }
            ...
            tv.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(v.getContext(), ViewInfoActivity.class);
                    intent.putExtra("C_ISSO", finalTv.getTag().toString());
                    intent.putExtra("C_TYPE_ISSO", isso.CTypeIsso);
