...
public class UploadPhotoActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction()
                    .replace(android.R.id.content, new UploadPhotoFragment())
                    .commit();
        }
        PreferenceManager.setDefaultValues(UploadPhotoActivity.this, R.xml.pref_general, false);
    }

    public class UploadPhotoFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Map<String, ?> keys = PreferenceManager.getDefaultSharedPreferences(UploadPhotoActivity.this).getAll();
            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(UploadPhotoActivity.this);
        ...
        public void startSync(boolean download) {
            String login = PreferenceManager.getDefaultSharedPreferences(UploadPhotoActivity.this).getString("Login", null);
            String pass = PreferenceManager.getDefaultSharedPreferences(UploadPhotoActivity.this).getString("Pass", null);
            ...
            SyncModule sm = new SyncModule(UploadPhotoActivity.this, myHandler);
            ...
            sm.dbHelper = new DBHelper(UploadPhotoActivity.this);
            sm.execute();
            //RefreshIssoList();
        }
        ...
        public Handler myHandler = new Handler() {
            public void handleMessage(Message msg) {
                AlertDialog.Builder bld = new AlertDialog.Builder(UploadPhotoActivity.this);
                ...
                alert.show();
                UploadPhotoActivity.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_SENSOR);
            }
        };
        ...
        class SyncModule extends AsyncTask<Void, String, Void> {
            ...
            private UploadPhotoActivity context;
            ...
            // Для JSON
            private final String[] JSONMETHODS = {"UploadPhotoInfoForIssos"};
            private final String[] JSONMETHODRESULTS = {"UploadPhotoInfoForIssosResult"};
            ...
            SyncModule(UploadPhotoActivity context, Handler myHandler) {
                attach(context);
                ...
                try {
                    ...
                    if(cr.moveToFirst()) {
                        ...
                        for(int i = 0; i < cr.getCount(); i++) {
                            publishProgress("Загрузка фото для ИССО: " + cr.getInt(cr.getColumnIndex("C_ISSO")));
                            Map<String, Object> params = new HashMap<>();
                            params.put("c_isso", cr.getInt(cr.getColumnIndex("C_ISSO")));
                            JSONObject object = ConnectToServer(JSONMETHODS[0], params);
                            Gson gson = new Gson();
                            assert object != null;
                            UploadPhotoForIsso[] photos = gson.fromJson(object.getString(JSONMETHODRESULTS[0]), UploadPhotoForIsso[].class);
            ...
            void attach(UploadPhotoActivity activity) {
