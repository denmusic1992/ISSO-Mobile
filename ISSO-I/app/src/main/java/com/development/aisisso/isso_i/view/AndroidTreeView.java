package com.development.aisisso.isso_i.view;
...
import com.development.aisisso.isso_i.R;
import com.development.aisisso.isso_i.holder.SimpleViewHolder;
...
public class AndroidTreeView {
    ...
    private TreeNode.BaseNodeViewHolder getViewHolderForNode(TreeNode node) {
        ...
        if (viewHolder.getTreeView() == null) {
            viewHolder.setTreeViev(AndroidTreeView.this);
        }
        return viewHolder;
    }
